...
void WalkController::Load(gazebo::physics::ModelPtr parent_, sdf::ElementPtr sdf_) {
    ...
    if (sdf_->HasElement("controlPeriod")) {
        ...
        //control_period = ros::Duration(0,000001);
...
void WalkController::Update() {
    ...
    //ros::Duration sim_period = ros::Duration(0.001000);

    /*
    ROS_INFO("======================================================================================================");
    ROS_INFO("________Walkcontroller::Update()___________");
    ROS_INFO("GZ_time_now: %o s " , gz_time_now.sec);
    ROS_INFO("sim_time_ros:  %f s " , sim_time_ros.toSec());

...
ModelViz::ModelViz(){
    ...
    visualization_control_sub = nh->subscribe("/roboy/visualization_control", 10,
                                              &ModelViz::visualization_control, this);
...
void ModelViz::visualization_control(const roboy_simulation::VisualizationControl::ConstPtr &msg) {
...
void ModelViz::publishCOM(math::Vector3 *center_of_mass) {
...
void ModelViz::publishSimulationState(ControllerParameters &params, gazebo::common::Time gz_time_now){
...
void ModelViz::publishLegState(LEG_STATE *leg_state){
...
void ModelViz::publishStateMachineParameters(math::Vector3 *center_of_mass,
...
void ModelViz::publishCoordinateSystems(physics::LinkPtr parent_link, ros::Time time, bool child_link){

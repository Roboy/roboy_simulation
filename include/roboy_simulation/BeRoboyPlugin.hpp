...
#include <roboy_communication_middleware/Position.h>
...
namespace gazebo
{
    class BeRoboyPlugin : public ModelPlugin
    {
    public:
        BeRoboyPlugin();
        ~BeRoboyPlugin();
	...
	void SetPosition(const roboy_communication_middleware::PositionConstPtr &_msg);
